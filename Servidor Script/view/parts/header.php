        ...
        <nav>
            ...
            <?php
                ...
                if(isset($usuarioNombre)){
                    echo "<button id=\"cerrarSesion\" type=\"button\" style=\"text-transform:capitalize;width:11em;margin:0\"class=\"btn btn-outline-dark\">$usuarioNombre
            ...
            <button id="carrito" type="button" style="width:11em"class="btn btn-outline-dark">Carrito
            <svg xmlns="http://www.w3.org/2000/svg" style="margin-left: 2%;" width="16" height="16" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16">
